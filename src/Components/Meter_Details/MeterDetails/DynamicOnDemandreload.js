...
const DynamicOnDemandreload = ({meternum, meterty, meterman}) => {
  ...
  return (
      ...
      <Row>
        ...
        <DynamicOnDemand key={key} meternum={meternum} meterty={meterty} meterman={meterman} />
      </Fragment>
  )
}

export default DynamicOnDemandreload
