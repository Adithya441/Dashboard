...
const DynamicConfigurationsreload = ({meternum, meterty, meterman}) => {
  ...
  return (
      ...
      <Row>
        ...
        <DynamicConfigurations key={key} meternum={meternum} meterty={meterty} meterman={meterman} />
      </Fragment>
  )
}

export default DynamicConfigurationsreload
